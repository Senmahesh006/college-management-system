...
public class AddTeacher extends AppCompatActivity {
    ...
    private  String name,email,post,dowloandUrl = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category","BCA","MCA","BSC","BA"};
    ...
    private void checkValidation() {
        ...
        if (post.isEmpty()){
            ...
            Toast.makeText(AddTeacher.this, "please provied Teacher Category", Toast.LENGTH_SHORT).show();
        }else if (bitmap == null){
    ...
    private void insertData() {
        ...
        TeacherData teacherData = new TeacherData(name,email,post,dowloandUrl, uniquekey);
